...
class Bit8_Asymmetric:
    name = "8bit_asymmetric"
    category = "quantization"

    def compress(self, tensor, block_size=128, **params):
        return _block_quantize_flat(tensor, 8, block_size, False)

    decompress = staticmethod(_block_dequantize_flat)
