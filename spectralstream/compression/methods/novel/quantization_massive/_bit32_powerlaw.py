...
import numpy as np
from spectralstream.compression.methods.novel._common import _power_law_dequantize
...
class Bit32_PowerLaw:
    name = "32bit_power_law"
    category = "quantization"

    def compress(self, tensor, **params):
        return _power_law_quantize(tensor, 32)

    decompress = staticmethod(_power_law_dequantize)
