...
import numpy as np
from spectralstream.compression.methods.novel._common import _block_float_dequantize
...
class Bit23_BlockFloat:
    name = "23bit_block_float"
    category = "quantization"

    def compress(self, tensor, block_size=32, **params):
        return _block_float_quantize(tensor, 23, block_size)

    decompress = staticmethod(_block_float_dequantize)
