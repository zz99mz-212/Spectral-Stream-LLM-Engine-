...
import numpy as np
from spectralstream.compression.methods.novel._common import _per_channel_dequantize
...
class Bit4_OutlierChannel:
    name = "4bit_outlier_channel"
    category = "quantization"

    def compress(self, tensor, **params):
        return _per_channel_quantize(tensor, 4, True)

    decompress = staticmethod(_per_channel_dequantize)
