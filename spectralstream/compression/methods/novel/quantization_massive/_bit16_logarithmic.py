...
import numpy as np
from spectralstream.compression.methods.novel._common import _log_dequantize
...
class Bit16_Logarithmic:
    name = "16bit_logarithmic"
    category = "quantization"

    def compress(self, tensor, **params):
        return _log_quantize(tensor, 16)

    decompress = staticmethod(_log_dequantize)
