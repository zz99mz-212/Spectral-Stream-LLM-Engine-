...
class IFSRotation:
    """A13: IFS-ROTATION — Rotation-dominated IFS transform encoding."""
    ...
    def compress(self, tensor: np.ndarray, **params) -> Tuple[bytes, dict]:
        ...
        angles = np.arctan2(kept, np.roll(kept, 1) + 1e-10)
        return struct.pack("<II", n, k) + _pack_f32(angles) + _pack_f32(
            kept
