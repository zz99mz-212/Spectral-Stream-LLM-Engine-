...
class PhaseConjDistortionCorrection:
    """F9: PHASE-CONJ-DISTORTION-CORRECTION — Distortion correction via phase conjugation."""

    name = "phase_conj_distortion_correction"
