...
class InterferThinFilm:
    """E7: INTERFER-THIN-FILM — Thin-film interference encoding."""

    name = "interfer_thin_film"
    ...
    def compress(self, tensor: np.ndarray, **params) -> Tuple[bytes, dict]:
        ...
        film = np.convolve(kept, [0.2, 0.6, 0.2], mode="same")[:k]
        return struct.pack("<II", n, k) + _pack_f32(film) + _pack_f32(
            kept
