...
class HRRAmplitudeEncoding:
    """D18: HRR-AMPLITUDE-ENCODING — Amplitude-based holographic encoding."""

    name = "hrr_amplitude_encoding"
    ...
    def compress(self, tensor: np.ndarray, **params) -> Tuple[bytes, dict]:
        ...
        amp = np.abs(kept)
        return struct.pack("<II", n, k) + _pack_f32(amp) + _pack_f32(
            kept
