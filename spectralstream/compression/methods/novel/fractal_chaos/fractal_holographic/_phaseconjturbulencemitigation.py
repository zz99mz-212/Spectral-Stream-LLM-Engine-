...
class PhaseConjTurbulenceMitigation:
    """F12: PHASE-CONJ-TURBULENCE-MITIGATION — Turbulence mitigation via phase conjugation."""

    name = "phase_conj_turbulence_mitigation"
