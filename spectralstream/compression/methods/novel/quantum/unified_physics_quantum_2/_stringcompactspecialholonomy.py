...
class StringCompactSpecialHolonomy:
    """Special holonomy G₂/Spin(7): calibrated associative/Cayley 4-form parallel transport SVD."""

    name = "stringcompactspecialholonomy"
