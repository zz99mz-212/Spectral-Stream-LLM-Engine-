...
class StringCompactMirrorSymmetry:
    """Mirror symmetry: Hodge diamond reflection h^{1,1} ↔ h^{2,1} via paired singular value mirroring."""

    name = "stringcompactmirrorsymmetry"
