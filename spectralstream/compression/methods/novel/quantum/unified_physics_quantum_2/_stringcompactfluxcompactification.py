...
class StringCompactFluxCompactification:
    """Flux compactification: RR/NS-NS 3-form flux quanta N_{RR}, N_{NS} as integer SVD."""

    name = "stringcompactfluxcompactification"
