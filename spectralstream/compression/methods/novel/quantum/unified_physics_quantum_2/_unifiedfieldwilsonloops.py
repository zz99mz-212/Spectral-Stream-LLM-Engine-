...
class UnifiedFieldWilsonLoops:
    """Wilson loop: traced holonomy observables as invariant singular value combinations from area law."""

    name = "unifiedfieldwilsonloops"
