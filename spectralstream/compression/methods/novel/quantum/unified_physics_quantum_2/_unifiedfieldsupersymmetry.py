...
class UnifiedFieldSupersymmetry:
    """SUSY GUT: superpartner singular value pairs with soft-breaking scale M_SUSY from spectral splitting."""

    name = "unifiedfieldsupersymmetry"
