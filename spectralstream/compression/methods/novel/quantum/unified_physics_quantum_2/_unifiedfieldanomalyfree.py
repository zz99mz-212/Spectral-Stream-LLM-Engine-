...
class UnifiedFieldAnomalyFree:
    """Anomaly cancellation: gauge anomaly-free SVD combination enforcing trace constraint cancellation."""

    name = "unifiedfieldanomalyfree"
