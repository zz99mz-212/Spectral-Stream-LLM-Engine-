...
class UnifiedFieldElectroweak:
    """Electroweak SU(2)×U(1) unification: store 4 gauge boson components as truncated SVD with Weinberg angle θ_W."""

    name = "unifiedfieldelectroweak"
