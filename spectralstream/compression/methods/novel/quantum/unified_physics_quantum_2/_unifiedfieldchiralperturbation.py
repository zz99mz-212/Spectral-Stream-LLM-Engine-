...
class UnifiedFieldChiralPerturbation:
    """Chiral perturbation theory χPT: pion decay f_π + L_i coefficients from low-energy spectrum fit."""

    name = "unifiedfieldchiralperturbation"
