...
class UnifiedFieldAnomalousDimension:
    """Anomalous dimension γ(μ) = d(log S)/d(log μ): power-law singular value decay exponent."""

    name = "unifiedfieldanomalousdimension"
