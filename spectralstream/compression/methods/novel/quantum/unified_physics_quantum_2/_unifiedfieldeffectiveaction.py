...
class UnifiedFieldEffectiveAction:
    """Quantum effective action Γ[ϕ]: 1PI cumulants from Legendre transform via moment tensor SVD."""

    name = "unifiedfieldeffectiveaction"
