...
class UnifiedFieldSymmetryBreaking:
    """Spontaneous symmetry breaking via Higgs VEV: vacuum expectation value + fluctuations around minimum."""

    name = "unifiedfieldsymmetrybreaking"
