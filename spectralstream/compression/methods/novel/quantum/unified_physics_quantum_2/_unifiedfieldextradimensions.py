...
class UnifiedFieldExtraDimensions:
    """Large extra dimensions: Kaluza-Klein tower mode spacing from radius R, quantized Fourier spectrum."""

    name = "unifiedfieldextradimensions"
