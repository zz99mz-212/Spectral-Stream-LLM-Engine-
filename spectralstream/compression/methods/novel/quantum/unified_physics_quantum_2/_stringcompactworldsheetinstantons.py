...
class StringCompactWorldsheetInstantons:
    """Worldsheet instantons: genus-g sum = multi-linear Fourier coupling in sigma model."""

    name = "stringcompactworldsheetinstantons"
