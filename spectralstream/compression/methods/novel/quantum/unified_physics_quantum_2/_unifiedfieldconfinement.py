...
class UnifiedFieldConfinement:
    """QCD confinement: Regge trajectory slope σ from singular value spacing, quark/gluon sectors separately."""

    name = "unifiedfieldconfinement"
