...
class UnifiedFieldTadpoleCancellation:
    """Tadpole cancellation: D-brane charge sum rules enforced via singular value constraints."""

    name = "unifiedfieldtadpolecancellation"
