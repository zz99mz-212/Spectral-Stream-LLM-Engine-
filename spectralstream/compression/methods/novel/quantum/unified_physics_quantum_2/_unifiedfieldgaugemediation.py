...
class UnifiedFieldGaugeMediation:
    """Gauge-mediated SUSY breaking: messenger fields as residual SVD modes beyond dominant MSSM sector."""

    name = "unifiedfieldgaugemediation"
