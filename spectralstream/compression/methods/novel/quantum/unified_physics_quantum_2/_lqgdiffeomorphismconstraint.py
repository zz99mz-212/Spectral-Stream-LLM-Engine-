...
class LQGDiffeomorphismConstraint:
    """Diffeomorphism constraint: diff-invariant flat singular spectrum from flatness measure."""

    name = "lqgdiffeomorphismconstraint"
