...
class UnifiedFieldGaugeCoupling:
    """Running gauge coupling: RG β-function coefficients fit to singular value mode decay hierarchy."""

    name = "unifiedfieldgaugecoupling"
