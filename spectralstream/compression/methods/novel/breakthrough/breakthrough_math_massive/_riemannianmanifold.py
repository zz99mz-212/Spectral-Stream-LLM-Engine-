...
class RiemannianManifold:
    """Riemannian manifold: smooth weight space with positive-definite metric"""
    name = "riemannian_manifold"; category = "breakthrough_math"
    ...
    def compress(self, tensor: np.ndarray, rank: int = 8) -> Tuple[bytes, dict]:
        ...
        param = float(np.linalg.norm(t2d @ t2d.T, 'fro'))
