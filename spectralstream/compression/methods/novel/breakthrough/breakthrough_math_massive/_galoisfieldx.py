...
class GaloisFieldX:
    """Galois field: finite field of characteristic p with Frobenius automorphism"""
    name = "galois_field_x"; category = "breakthrough_math"
    ...
    def compress(self, tensor: np.ndarray, rank: int = 8) -> Tuple[bytes, dict]:
        ...
        param = float(np.mean(np.abs(t2d)**2))
