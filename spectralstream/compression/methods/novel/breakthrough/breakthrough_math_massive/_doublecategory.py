...
class DoubleCategory:
    """Double category: two-dimensional category with horizontal and vertical arrows"""
    name = "double_category"; category = "breakthrough_math"
    ...
    def compress(self, tensor: np.ndarray, rank: int = 8) -> Tuple[bytes, dict]:
        ...
        m2 = min(m, n//2)*2
        param = float(np.linalg.norm(t2d[:m2:2,:m2:2] - t2d[1:m2:2,1:m2:2]))
