...
class AffineVariety:
    """Affine variety: zero locus of polynomial equations in weight space"""
    name = "affine_variety"; category = "breakthrough_math"
    ...
    def compress(self, tensor: np.ndarray, rank: int = 8) -> Tuple[bytes, dict]:
        ...
        param = float(np.mean(np.abs(t2d - np.mean(t2d))))
