...
class IntersectionHomology:
    """Intersection homology: perverse sheaves on singular weights"""
    name = "intersection_homology"; category = "breakthrough_math"
    ...
    def compress(self, tensor: np.ndarray, rank: int = 8) -> Tuple[bytes, dict]:
        ...
        param = float(np.median(np.abs(t2d.ravel())))
