...
class SymmetricSpace:
    """Symmetric space: homogeneous with involutive symmetry"""
    name = "symmetric_space"; category = "breakthrough_math"
    ...
    def compress(self, tensor: np.ndarray, rank: int = 8) -> Tuple[bytes, dict]:
        ...
        param = float(np.linalg.norm(t2d_sq @ t2d_sq.T - t2d_sq.T @ t2d_sq))
