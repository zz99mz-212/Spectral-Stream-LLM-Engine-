...
class HomotopyCategory:
    """Homotopy category: complexes modulo homotopy equivalence"""
    name = "homotopy_category"; category = "breakthrough_math"
    ...
    def compress(self, tensor: np.ndarray, rank: int = 8) -> Tuple[bytes, dict]:
        ...
        param = float(np.linalg.norm(t2d @ t2d.T - t2d.T @ t2d))
