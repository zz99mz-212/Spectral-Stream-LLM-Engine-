...
class HyperkahlerManifold:
    """Hyperkähler manifold: three complex structures satisfying quaternion relations"""
    name = "hyperkahler_manifold"; category = "breakthrough_math"
    ...
    def compress(self, tensor: np.ndarray, rank: int = 8) -> Tuple[bytes, dict]:
        ...
        param = float(np.linalg.norm(t2d @ t2d.T - t2d.T @ t2d, 'fro'))
