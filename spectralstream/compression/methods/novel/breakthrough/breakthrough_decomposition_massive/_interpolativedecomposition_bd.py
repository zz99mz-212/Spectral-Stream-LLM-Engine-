...
class InterpolativeDecomposition_bd:
    """InterpolativeDecomposition_bd: Interpolative Decomposition (ID)."""
    name = "interpolative_decomposition_bd"
    ...
    def compress(self, tensor: np.ndarray, **params) -> Tuple[bytes, dict]:
        ...
        return data, {"shape": orig_shape, "k": k}
