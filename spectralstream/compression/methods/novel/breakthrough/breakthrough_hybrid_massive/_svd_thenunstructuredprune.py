...
class SVD_ThenUnstructuredPrune:
    name = "svd_then_unstructured_prune"
    category = "breakthrough_hybrid"

    def compress(self, tensor, **params):
        return _unstructured_prune(tensor, params.get("sparsity", 0.5))

    def decompress(self, data, meta=None):
        return _unstructured_prune_decompress(data, meta or {})
