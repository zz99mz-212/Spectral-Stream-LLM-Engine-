...
class SVD_ThenProductQuant:
    name = "svd_then_product_quant"
    category = "breakthrough_hybrid"

    def compress(self, tensor, **params):
        return _product_quantize(tensor, params.get("n_subq", 8))

    def decompress(self, data, meta=None):
        return _product_quantize_decompress(data, meta or {})
