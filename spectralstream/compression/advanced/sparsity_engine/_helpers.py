"""Common helper functions for the sparsity_engine package.

Duplicated utility functions consolidated from the original monolithic
sparsity_engine.py file.
"""
...
def _nm_mask(shape: tuple, n: int, m: int, rng_seed: int | None = None) -> np.ndarray:
    rows, cols = shape
