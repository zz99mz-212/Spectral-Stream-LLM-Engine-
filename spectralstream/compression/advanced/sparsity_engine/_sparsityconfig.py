...
class SparsityConfig:
    ...
    sparsity_pattern: str = "unstructured"
    block_size: int = 32
    nm_ratio: tuple = (2, 4)
    channel_prune_fraction: float = 0.3
    spectral_keep_fraction: float = 0.1
    activation_threshold: float = 0.01
    adaptive_enabled: bool = True
    fallback_density_threshold: float = 0.4
    vlasov_interaction_threshold: float = 0.05
    resonance_frequency_bands: int = 8
    hrr_dim: int = 4096
    self_organizing_iterations: int = 3
    quantum_superposition_size: int = 4
